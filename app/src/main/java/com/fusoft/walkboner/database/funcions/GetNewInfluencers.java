...
public class GetNewInfluencers {
    ...
    public GetNewInfluencers(String sort, InfluencersListener listener) {
        ...
        firestore.collection("moderation").document("influencers").collection("toModerate").orderBy("influencerAddedAt", Query.Direction.DESCENDING).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
