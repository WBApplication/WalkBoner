...
public interface AuthenticationListener {
     ...
     */
    default void UserAlreadyLoggedIn(boolean success, boolean isBanned, boolean pinRequired, @Nullable String reason, @Nullable User userData) {}
     ...
     */
    default void UserRequiredToBeLogged() {}
     ...
     */
    default void OnLogin(boolean isSuccess, boolean isBanned, boolean pinRequired, @Nullable String reason) {}
     ...
     * @param reason if isSuccess = false, then it returns reason why it failed. It will be null when isSuccess is true.
     */
    default void OnRegister(boolean isSuccess, @Nullable String reason) {}
}
